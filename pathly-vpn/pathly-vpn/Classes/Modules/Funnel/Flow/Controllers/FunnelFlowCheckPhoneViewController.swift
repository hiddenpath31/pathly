//
//  FunnelFlowCheckPhoneViewController.swift
//  GrowVPN
//
...
class FunnelFlowCheckPhoneViewController: UIViewController {

    var presenter: FunnelFlowPresenterInterface?
    var funnelView = FunnelCheckingYourPhoneView()
...
//        self.view.addSubview(funnelView)
    ...
    private func setupBindings() {
        ...
        funnelView.didCheckingOver = { [weak self] in
...
extension FunnelFlowCheckPhoneViewController: FunnelFlowView {
